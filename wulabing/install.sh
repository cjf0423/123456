...
web_camouflage(){
    ...
    git clone https://github.com/cjf935257177/123456/levis.git
    judge "web 站点伪装"   
}
v2ray_install(){
...
v2ray_conf_add(){
    cd /etc/v2ray
    wget https://raw.githubusercontent.com/cjf935257177/123456/master/wulabing/tls/config.json -O config.json
modify_port_UUID
judge "V2ray 配置修改"
}
nginx_conf_add(){
